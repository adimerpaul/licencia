  ...
  <q-page class="q-pa-xs">
    <q-card>
      <q-card class="q-pa-xs">
        ...
        <div class="row">
          <div class="col-12">
            <q-input label="id" outlined v-model="id" @keyup.enter="consulta" autofocus/>
          </div>
          <div class="col-12">
            <q-select
              outlined
...
export default {
  ...
  methods:{
    ...
    consulta(){
      console.log(this.id)
      this.$q.loading.show()
      this.$axios.get(process.env.API+'/direccion/'+this.id).then(res=>{
        // this.tramites=[]
        // this.tramites2=[]
        // res.data.forEach(r=>{
        //   console.log(r)
        ...
        this.seguimientos=res.data[0].seguimientos
        this.licencia=''
        if (res.data[0].licencia!=null){
          this.licencia=res.data[0].licencia
        }
